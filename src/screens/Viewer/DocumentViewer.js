...
import  PDF from '../../assets/ucc-and-you.pdf'
                    ...
                    <div className="flex flex-wrap items-center justify-between pb-4 -mx-2">
                        <div className="w-full md:w-1/2 px-2 mb-4 md:mb-0">
                            <div className="flex flex-wrap items-end">
                                ...
                                <div className="relative bottom-px pb-px w-auto">
                                    <div >
                                        <button className='bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 mx-3 px-6 rounded-l' onClick={prevPage} disabled={pageNumber === 1}>
                                            Prev
                                        </button>
                                        <button className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-6 rounded-l" onClick={nextPage} disabled={pageNumber === numPages}>
                                            Next
                                        </button>
                        ...
                        <div className="w-full md:w-1/2 px-2">
                            <div className="relative md:max-w-max md:ml-auto">
                                <svg className="absolute left-3 transform top-1/2 -translate-y-1/2" width="16"
                                ...
                                <input
                                    className="w-full md:w-64 pl-8 pr-4 py-2 text-sm text-coolGray-400 font-medium outline-none focus:border-blue-500 border border-coolGray-200 rounded-lg shadow-input"
