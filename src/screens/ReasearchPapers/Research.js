        ...
        <section className="bg-coolGray-50 py-4">
            <div className="container px-4 mx-auto">
                <div className="pt-6 bg-white overflow-hidden border border-coolGray-100 rounded-md shadow-dashboard">
                    <h2 className="px-6 mb-4 text-lg text-coolGray-900 font-semibold">List of Projects and Research
                        Papers</h2>
                    <div className="px-6 overflow-x-auto">
                        <table className="w-full">
                            <tbody>
                            <tr className="whitespace-nowrap h-14 bg-coolGray-50 bg-opacity-80 mb-4">
                                <th className="px-4 font-semibold text-xs text-coolGray-500 uppercase text-left rounded-l-md">
                                    <p>Paper</p>
                                </th>
                                <th className="whitespace-nowrap px-4 font-semibold text-xs text-coolGray-500 uppercase text-center">Category</th>
                                <th className="whitespace-nowrap px-4 font-semibold text-xs text-coolGray-500 uppercase text-center">Author</th>
                                <th className="whitespace-nowrap px-4 font-semibold text-xs text-coolGray-500 uppercase text-center">Topic
                                </th>
                                <th className="whitespace-nowrap px-4 font-semibold text-xs text-coolGray-500 uppercase text-center">Completion</th>
                                <th className="whitespace-nowrap px-4 font-semibold text-xs text-coolGray-500 uppercase text-center rounded-r-md">Date
                                    Submitted
                                </th>
                            </tr>
                            <tr className="h-24 border-b border-coolGray-50 mb-4 ">
                                <th className="whitespace-nowrap px-4 bg-white text-left">
                                    <div className="flex items-center -m-2">
                                        <div className="w-auto p-2">
                                            <div
                                                className="flex items-center justify-center w-10 h-10 text-base font-medium bg-blue-500 rounded-md">
                                        ...
                                        <div className="w-auto p-2">
                                            <p className="text-sm font-medium text-coolGray-800">CS Stereotypes</p>
                                        </div>
                                    </div>
                                </th>
                                <th className="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-800 text-center">Social
                                    Experiment
                                </th>
                                <th className="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-800 text-center">Lemuria</th>
                                <th className="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-800 text-center">Social
                                    Balance
                                </th>
                                <th className="whitespace-nowrap px-4 bg-white text-sm font-medium text-green-500 text-center">43.5%</th>
                                <th className="whitespace-nowrap px-4 bg-white text-sm font-medium text-gray-500 text-center">12
                                    June 2028
                                </th>
                            </tr>
                            <tr className="h-24 border-b border-coolGray-50 mb-4 ">
                    ...
                    <div className="flex flex-wrap items-center justify-between w-full lg:w-1/2 py-4 px-6 -m-2">
                        <div className="w-auto p-2">
                            <p className="text-sm font-semibold text-coolGray-500">Showing 21 to 30 of 2650 results</p>
                        </div>
                        <div className="w-auto p-2">
                            <div className="flex flex-wrap items-center">
                                <div className="w-auto mr-3">
                                    <div className="relative flex items-center">
                                        <svg className="absolute right-4 top-1/2 transform -translate-y-1/2" width="10"
